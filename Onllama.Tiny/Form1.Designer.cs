namespace Onllama.Tiny
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            select1.Items.AddRange(new object[] { "qwen:4b", "qwen2:7b", "qwen:14b", "qwen:32b", "yi:6b", "yi:9b", "yi:34b", "llama3:8b", "phi3:3.8b", "phi3:14b", "aya:8b", "aya:35b", "command-r:35b", "gemma2:9b", "deepseek-v2:16b", "glm4:9b" });
